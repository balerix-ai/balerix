...
/// System ⊕ user ⊕, when `with_gh`, `gh = <balerix's pinned gh>` (spec §4.2
...
/// be fully determined by the layout alone — nothing in `balerix-runtime`
...
mod tests {
    ...
    fn render_merges_user_over_system_and_drops_gh_without_auth() {
        ...
        assert_eq!(
            with,
            "# generated by balerix for agent payments/backend/alice; edit the fleet file, not this\n[tools]\nclaude = \"2.1.0\"\ngh = \"2.100.0\"\nnode = \"22.11.0\"\n"
        );
